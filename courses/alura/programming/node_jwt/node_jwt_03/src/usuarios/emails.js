...
class EmailRedefinicao extends Email {
  constructor (usuario, token) {
    ...
    this.text = `Olá! Você requisitou uma redefinição de senha. Utilize o token para trocar a sua senha: ${token}.`
    this.html = `<h1>Olá!</h1> Utilize o token para trocar a sua senha: ${token}.`
  }
}

module.exports = { EmailVerificacao, EmailRedefinicao }
